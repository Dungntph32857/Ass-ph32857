<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
    <div class="sidebar">
        ...
        {{--  <div class="widget">
            ...
            <div class="trend-videos">
                <div class="blog-box">
                    <div class="post-media">
                        <a href="tech-single.html" title="">
                            <img src="/client/upload/tech_video_01.jpg" alt="" class="img-fluid">
                ...
                <div class="blog-box">
                    <div class="post-media">
                        <a href="tech-single.html" title="">
                            <img src="/client/upload/tech_video_02.jpg" alt="" class="img-fluid">
                            <div class="hovereffect">
                                <span class="videohover"></span>
                            </div><!-- end hover -->
                        </a>
                ...
                <div class="blog-box">
                    <div class="post-media">
                        <a href="tech-single.html" title="">
                            <img src="/client/upload/tech_video_03.jpg" alt="" class="img-fluid">
                            <div class="hovereffect">
                                <span class="videohover"></span>
                            </div><!-- end hover -->
                        </a>
            ...
            <div class="blog-list-widget">
                <div class="list-group">
                    <a href="tech-single.html"
                        class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="w-100 justify-content-between">
                            <img src="/client/upload/tech_blog_02.jpg" alt="" class="img-fluid float-left">
                    ...
                    <a href="tech-single.html"
                        ...
                        <div class="w-100 last-item justify-content-between">
                            <img src="/client/upload/tech_blog_07.jpg" alt="" class="img-fluid float-left">
        ...
        <div class="widget">
            <div class="banner-spot clearfix">
                <div class="banner-img">
                    <img src="/client/upload/banner_03.jpg" alt="" class="img-fluid">
                </div><!-- end banner-img -->
            </div><!-- end banner -->
        </div><!-- end widget -->
    </div><!-- end sidebar -->
