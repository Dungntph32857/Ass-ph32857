        ...
        <div class="masonry-blog clearfix">
            <div class="first-slot">
                <div class="masonry-box post-media">
                    <img src="/client/upload/tech_01.jpg" alt="" class="img-fluid">
            ...
            <div class="second-slot">
                <div class="masonry-box post-media">
                    <img src="/client/upload/tech_02.jpg" alt="" class="img-fluid">
                    <div class="shadoweffect">
                        <div class="shadow-desc">
                            <div class="blog-meta">
                                <span class="bg-orange"><a href="tech-category-01.html"
            ...
            <div class="last-slot">
                <div class="masonry-box post-media">
                    <img src="/client/upload/tech_03.jpg" alt="" class="img-fluid">
                    <div class="shadoweffect">
                        <div class="shadow-desc">
                            <div class="blog-meta">
                                <span class="bg-orange"><a href="tech-category-01.html"
